...
class InputRecorder {
  ...
  static async create(context: Context, browserContext: playwright.BrowserContext): Promise<InputRecorder> {
  ...
  private async _initialize() {
    ...
    await (this._browserContext as unknown as {
      _enableRecorder(
        ...
        sink: {
          actionAdded: (page: playwright.Page, data: actions.ActionInContext, code: string) => void;
          actionUpdated: (page: playwright.Page, data: actions.ActionInContext, code: string) => void;
          signalAdded: (page: playwright.Page, data: actions.SignalInContext) => void;
        },
      ): Promise<void>;
    })._enableRecorder({
      mode: 'recording',
